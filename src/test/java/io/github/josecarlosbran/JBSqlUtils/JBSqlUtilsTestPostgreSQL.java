...
public class JBSqlUtilsTestPostgreSQL {
     ...
     */
    @Test(testName = "First Or Fail Get", dependsOnMethods = "firstOrFailGet"
            , expectedExceptions = ModelNotFound.class)
    ...
    public void setPropertiesConexion() {
        ...
        Assert.assertTrue(DataBase.PostgreSQL.name().equalsIgnoreCase(System.getProperty(ConeccionProperties.DBTYPE.getPropiertie())),
